...
// TableName 表名
func (u *EmBaseData) TableName() string {
	return "base_data"
}

// TableEngine 设置引擎为 INNODB
func (u *EmBaseData) TableEngine() string {
	return "INNODB"
}

// EmBaseFu 用户福袋数据表
type EmBaseFu struct {
	ID     int `orm:"column(id);pk;auto" xorm:"INT(11) notnull pk autoincr 'id'" json:"id"`
...
// TableName 表名
func (u *EmBaseFu) TableName() string {
	return "base_fu"
}

// TableEngine 设置引擎为 INNODB
func (u *EmBaseFu) TableEngine() string {
	return "INNODB"
}
